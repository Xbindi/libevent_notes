/**********************************************************
 * 程序说明：包含了一个客户端和一个服务器,分别使用了bufferevent
 * 客户端发送本文件给服务器，接收完成后完成发送
 *********************************************************/
...
{//大括号表示一个代码区域，变量不会和外面冲突
	...
	memset(&sin, 0, sizeof(sin));
	sin.sin_family = AF_INET;
	sin.sin_port = htons(5001);//主机字节序转网络字节序
